...
import { mauzlLogo } from '~email/email.util';
...
export const OrderConfirmationEmail = ({
  ...
  orderDetails: {
    ...
    orderDate: string;
    products: [
      { id: string; image: string; name: string; size: string; color: string },
    ];
  };
}) => (
  <Html>
      ...
      <Container style={container}>
        <Section style={track.container}>
          <Row>
            <Column>
              ...
              <Text style={track.number}>{orderDetails.trackingNumber}</Text>
            </Column>
            <Column align="right">
        ...
        <Section style={message}>
          ...
          <Text style={{ ...global.text, marginTop: 24 }}>
            ...
            please visit your Orders page on Mauzl.com or in the Mauzl app.
          </Text>
        </Section>
        <Hr style={global.hr} />
        ...
        <Section style={global.defaultPadding}>
          <Row style={{ display: 'inline-flex', marginBottom: 40 }}>
            <Column style={{ width: '170px' }}>
              ...
              <Text style={track.number}>{orderDetails.orderNumber}</Text>
            </Column>
            <Column>
              <Text style={global.paragraphWithBold}>Order Date</Text>
              <Text style={track.number}>{orderDetails.orderDate}</Text>
            </Column>
          </Row>
          <Row>
            <Column align="center">
        ...
        <Section style={paddingY}>
          <Row>
            <Text style={global.heading}>Mauzl.com</Text>
          </Row>
        ...
        <Section style={paddingY}>
          ...
          <Row>
            <Text style={footer.text}>
              © 2025 Mauzl, Inc. All Rights Reserved.
            </Text>
          </Row>
          <Row>
            <Text style={footer.text}>
              Mauzl, INC. One Bowerman Drive, Beaverton, Oregon 97005, MOROCCO.
            </Text>
          </Row>
        </Section>
      </Container>
